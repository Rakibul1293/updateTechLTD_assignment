...
import { Row, Col, Typography, Input, Form, Button, Radio, Select, message, Checkbox, Upload } from 'antd';
...
const FormApp = () => {
    ...
    const handleSubmit = (values: any) => {
        console.log(values);
        setLoading(true);
        axios.post(`http://localhost:5000/userInfo`, values)
            .then(res => {
                setLoading(false);
                ...
                <Col span={18}>
                    <Form {...layout} onFinish={handleSubmit}>
                        ...
                        <div style={{ textAlign: "right" }}>
                            ...
                            <Button danger htmlType="button" onClick={() => history.push('/list')}>Back</Button>
                        </div>
                    </Form>
                </Col>
            </Row>
